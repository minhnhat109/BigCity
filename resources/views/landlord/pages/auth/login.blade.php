                        ...
                        <div class="sign-in-from">
                            ...
                            <form class="mt-4">
                                <div class="form-group">
                                    ...
                                    <input type="email" class="form-control mb-0" id="email" name="email" placeholder="Enter your email or phone number">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputPassword1">Password</label>
                                    <input type="password" class="form-control mb-0" id="password" name="password" placeholder="Enter password">
                ...
                $.ajax({
                    ...
                    success :   function(res) {
                        if(res.status) {
                            ...
                            window.setTimeout(() => {
                                window.location.href = "/landlord/room";
                            }, 500);
                        } else {
                            toastr.error('Login failed!');
                            $("#checkpassword").text("The password does not exist or you entered it incorrectly");
